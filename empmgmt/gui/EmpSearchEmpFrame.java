...
public class EmpSearchEmpFrame extends javax.swing.JFrame {

    /**
     * Creates new form EmpSearchEmpFrame
     */
    public EmpSearchEmpFrame() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmpSearchEmpFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EmpSearchEmpFrame().setVisible(true);
            }
        });
    }
